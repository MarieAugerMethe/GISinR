...
Note that WGS84 and NAD83 are very similar. 

<<epsgSearch, fig.width=9>>=
# Can search the epsg list of projection
# First make a data frame of EPSG project codes
EPSG <- make_EPSG()
# Can search this list using key words, e.g. Nova Scotia
